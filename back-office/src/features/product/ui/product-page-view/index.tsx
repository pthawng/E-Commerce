...
import { useProducts, useCreateProduct, useUpdateProduct, useProduct, useDeleteProductMedia, useSetProductThumbnail } from '../../model/hooks';
import type { Product } from '@shared';

const { Title, Text } = Typography;

export function ProductPageView() {
    const { filters, setFilters, setSearch, resetFilters } = useProductStore();
    ...
    return (
        <div className="space-y-8 pb-10">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 bg-white/60 p-8 rounded-3xl border border-[#D4AF37]/20 backdrop-blur-xl shadow-sm relative overflow-hidden">
                <div className="absolute top-0 right-0 w-64 h-64 bg-gradient-to-br from-[#6D28D9]/5 to-[#D4AF37]/5 rounded-bl-full -z-10"></div>
                <div>
                ...
                <Space size="middle">
                    ...
                    <Button
                        ...
                        className="!bg-gradient-to-r !from-[#6D28D9] !to-[#4C1D95] !border-none !text-white hover:!shadow-lg hover:!shadow-violet-200 font-medium h-11 px-7 rounded-xl transition-all hover:scale-105"
                    >
                        Tạo sản phẩm
                    </Button>
                </Space>
