...
export const ConciergePage: React.FC = () => {
  ...
  const getTier = (ltv: number) => {
    if (ltv > 100000)
      return { label: "Jade", color: "bg-green-900 text-green-100" };
    if (ltv > 50000) return { label: "Onyx", color: "bg-black text-white" };
    if (ltv > 10000)
      return { label: "Platinum", color: "bg-slate-300 text-slate-800" };
    ...
    <div className="space-y-12 pb-8 animate-in fade-in duration-1000">
      ...
      <div className="flex justify-between items-end border-b border-gray-100 dark:border-gray-900 pb-8">
        ...
        <div className="space-y-1">
          {" "}
          <Text className="tracking-luxury uppercase text-[10px] text-gray-400 font-bold block">
            Relationship Management
          </Text>{" "}
          <Title level={1} className="!mb-0 font-light text-5xl">
            Concierge Desk
          </Title>{" "}
        </div>{" "}
        <Space>
          ...
          <Button
            type="primary"
            icon={<PlusOutlined />}
            className="h-12 px-8 bg-black dark:bg-[#d4af37] border-none uppercase tracking-widest text-[9px] font-bold"
          >
            {" "}
            Add New Patron{" "}
          </Button>{" "}
      ...
      <Row gutter={[48, 0]}>
        ...
        <Col span={8}>
          ...
          <Card
            bordered={false}
            className="bg-[#fcfcfc] dark:bg-white/[0.02] p-2"
          >
            {" "}
            {statsLoading ? (
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  {" "}
                  <Text className="text-[10px] tracking-widest uppercase text-gray-400 block">
                    Top Patron
                  </Text>{" "}
        ...
        <Col span={8}>
          ...
          >
            ...
            <div className="flex justify-between items-center h-full pt-2">
              ...
              <div>
                {" "}
                <Text className="text-[10px] tracking-widest uppercase text-gray-400 block inline-block mr-2">
                  New Bespoke Inquiries
                </Text>{" "}
                <Badge
      ...
      <div className="space-y-6">
        ...
        <div className="flex justify-between items-center">
          ...
          <Button
            icon={<SearchOutlined />}
            type="text"
            className="text-gray-400 uppercase text-[9px] tracking-widest font-bold"
          >
            Search Database
          </Button>{" "}
        </div>{" "}
          ...
          columns={[
              ...
              render: (t) => (
                <Space>
                  ...
                  <Avatar
                    size="small"
                    shape="square"
                    className="bg-gray-100 text-[9px] font-bold text-gray-400"
                  >
                    {t[0]}
                  </Avatar>{" "}
            ...
            },
            {
              ...
              render: (v) => {
                ...
                return (
                  <Tag
                    className={`rounded-none border-none px-3 text-[8px] uppercase tracking-widest font-bold ${tier.color}`}
                  >
                    {" "}
                    {tier.label} Member{" "}
                  </Tag>
            ...
            },
            {
              ...
              key: "ltv",
              render: (v) => (
                <Text className="text-xs font-serif font-bold text-[#0e2258] dark:text-[#d4af37]">
                  {formatCurrency(v || 0)}
                </Text>
              ),
            },
