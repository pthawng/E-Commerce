...
const NotFoundPage: React.FC = () => {
    ...
    const quickLinks = [
        { title: 'Inventory Management', path: '/products', icon: <HomeOutlined /> },
        { title: 'Order Fulfillment', path: '/orders', icon: <ShoppingOutlined /> },
        { title: 'Business Analytics', path: '/analytics', icon: <SearchOutlined /> },
    ];
        ...
        <div className="flex flex-col items-center justify-center min-h-[70vh] py-12 px-4 text-center">
            ...
            <div className="relative z-10 max-w-lg w-full space-y-8">
                <div className="space-y-4">
                    <Title level={1} className="font-serif !mb-0 text-5xl">Page not found</Title>
                ...
                <div className="space-y-4 pt-8">
                    <Text className="text-[10px] uppercase tracking-[0.3em] text-gray-400 font-medium">Quick Recoveries</Text>
                    <List
                            ...
                            >
                                <Space className="w-full justify-between">
                                    <Space>
                                        ...
                                        <Text className="text-xs group-hover:pl-2 transition-all">{item.title}</Text>
                                    </Space>
