...
import { 
    Typography, Tabs, Space, Row, Col, Card 
} from 'antd';
import { 
    SyncOutlined, MailOutlined, ClockCircleOutlined, 
                ...
                <Row gutter={24} align="middle">
                    <Col span={4}>
                        <div className="flex flex-col items-center border-r border-gray-800 py-4">
                            ...
                            <Text className="text-emerald-500 uppercase text-[9px] font-bold tracking-widest">{t('nerve_center.health')}</Text>
                        </div>
                    </Col>
                    <Col span={20}>
                        <div className="flex justify-between items-center px-4">
                            <div>
                                <Title level={4} className="!text-white !mb-1 font-serif">{t('nerve_center.matrix')}</Title>
                                <Text className="text-gray-500 text-[10px] uppercase tracking-[0.2em]">FAANG-Grade L8 Monitoring</Text>
                            </div>
                            <Space size={24}>
                                <div className="text-right">
                                    <div className="text-[10px] text-gray-500 uppercase tracking-widest font-bold">{t('nerve_center.worker')}</div>
                                    <div className="text-emerald-400 font-bold text-xs uppercase">Healthy</div>
                                </div>
                                <div className="text-right">
                                    <div className="text-[10px] text-gray-500 uppercase tracking-widest font-bold">{t('nerve_center.drift')}</div>
                ...
                items={[
                    {
                        ...
                        label: (
                            <Space size={6}>
                                <SyncOutlined />
                                <span className="text-[10px] uppercase tracking-widest font-bold">{t('nerve_center.tabs.events')}</span>
                            </Space>
                        ),
                        children: (
                    ...
                    },
                    {
                        ...
                        label: (
                            <Space size={6}>
                                <MailOutlined />
                                <span className="text-[10px] uppercase tracking-widest font-bold">{t('nerve_center.tabs.email')}</span>
                            </Space>
                        ),
                        children: (
                            <WidgetErrorBoundary fallbackTitle={t('common.error_boundary_title')}>
                    ...
                    },
                    {
                        ...
                        label: (
                            <Space size={6}>
                                <ClockCircleOutlined />
                                <span className="text-[10px] uppercase tracking-widest font-bold">{t('nerve_center.tabs.audit')}</span>
                            </Space>
                        ),
                        children: (
