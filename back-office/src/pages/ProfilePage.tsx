        ...
        onError: (error: any) => {
            notification.error({
                ...
                description:
                    ...
                    t('profile.update_error', { defaultValue: 'Could not update profile' }),
            });
        },
    });
                ...
                >
                    ...
                    <div style={{ paddingBottom: 8 }}>
                        ...
                        <Space>
                            ...
                            >
                                <ClockCircleOutlined /> {t('profile.joined', { defaultValue: 'Joined' })}{' '}
                                                ...
                                                dataSource={[
                                                    {
                                                        ...
                                                        date: '2 hours ago',
                                                        desc: 'Changed nickname to Johnny',
                                                    },
                                                    {
                                                        title: 'Login detected',
                                                        date: '5 hours ago',
                                                        desc: 'Secure login from Chrome / Windows',
                                                    },
                                                    {
                                                        title: 'Password changed',
                                                        date: '3 days ago',
                                                        desc: 'Account security updated successfully',
                                                    },
                                                ]}
                                                renderItem={item => (
                                                    <List.Item>
                ...
                <Col xs={24} lg={8}>
                    ...
                    >
                        <Space direction="vertical" style={{ width: '100%' }} size={16}>
                            ...
                            <Button block ghost type="primary" icon={<GlobalOutlined />}>
                    ...
                    >
                        <Paragraph type="secondary">
                            {t('profile.preferences_sync_note', {
                                defaultValue:
                                    'Your preferences (language, theme) are synced across all your devices.',
                            })}
                        </Paragraph>
                        <Button type="link" style={{ padding: 0 }}>
                            {t('profile.view_all_preferences')}
                        </Button>
                    </Card>
                </Col>
            </Row>
