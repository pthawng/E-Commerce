...
export const attributeApi = {
    getAll: () =>
        api.get<AttributeItem[]>('/attributes').then(res => res.data),

    getById: (id: string) =>
        api.get<AttributeItem>(`/attributes/${id}`).then(res => res.data),

    create: (data: CreateAttributePayload) =>
        api.post<AttributeItem>('/attributes', data).then(res => res.data),

    update: (id: string, data: UpdateAttributePayload) =>
        api.patch<AttributeItem>(`/attributes/${id}`, data).then(res => res.data),
    ...
    getValues: (attributeId: string) =>
        api.get<AttributeValueItem[]>(`/attributes/${attributeId}/values`).then(res => res.data),

    createValue: (attributeId: string, data: CreateAttributeValuePayload) =>
        api.post<AttributeValueItem>(`/attributes/${attributeId}/values`, data).then(res => res.data),

    updateValue: (attributeId: string, valueId: string, data: UpdateAttributeValuePayload) =>
        api.patch<AttributeValueItem>(`/attributes/${attributeId}/values/${valueId}`, data).then(res => res.data),

    deleteValue: (attributeId: string, valueId: string) =>
        api.delete(`/attributes/${attributeId}/values/${valueId}`).then(res => res.data),
