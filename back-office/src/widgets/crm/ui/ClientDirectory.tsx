    ...
    },
    {
      ...
      render: (_: any, record: CustomerListItem) => {
        ...
        return (
          <Tag
            color={
              isVIP ? "gold" : isLoyal ? "blue" : isActive ? "green" : "default"
            }
          ...
          <div className="space-y-1">
            ...
            <Tooltip title="Lifetime Orders">
              ...
              <Space size={4} className="text-[10px] font-bold text-gray-400">
                {" "}
                <ShoppingOutlined className="text-gray-300" /> {orderCount}{" "}
                {t("common.orders")}{" "}
              </Space>{" "}
            </Tooltip>{" "}
            <br />{" "}
    ...
    <div className="space-y-6">
      ...
      <Table
        ...
        pagination={{
          current: page,
          pageSize: 15,
          total: customers?.meta?.totalItems || 0,
          onChange: setPage,
