        ...
        },
        {
            ...
            render: (total: number, record) => (
                <span className="font-medium">
                    {new Intl.NumberFormat('en-US', { style: 'currency', currency: record.totals.currency }).format(total)}
                </span>
            ),
        },
        {
            ...
            render: (status: OrderStatus) => (
                <Tag color={statusColorMap[status]} className="uppercase text-[10px] rounded-none px-2 font-bold border-none">
                    {status.replace('_', ' ')}
                </Tag>
            ),
        },
        ...
        },
        {
            ...
            render: () => (
                <Space size="middle">
                    ...
                    <Button type="primary" size="small" className="bg-black border-none text-[10px] uppercase h-7">Process</Button>
                </Space>
            ),
        },
    ];
        ...
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-xs text-gray-400 italic">Orchestrate the journey of each timeless piece.</p>
                </div>
            </div>
