...
import { inventoryApi, Warehouse } from "@/entities/inventory/api/inventoryApi";
  ...
  const columns = [
    {
      ...
      render: (_: any, record: Warehouse) => (
        <div className="flex items-center space-x-3">
          ...
          <div>
            {" "}
            <Text strong className="font-serif block leading-tight">
              {record.name}
            </Text>{" "}
            <Text
              type="secondary"
      ...
      render: (
        ...
        return (
          <Space size={4}>
            ...
            <Text className="text-sm italic text-gray-500 font-serif">
              {addressStr || "N/A"}
            </Text>{" "}
          </Space>
        );
    ...
    },
    {
      ...
      render: (isActive: boolean) => (
        <Tag
          ...
          className="rounded-none border-none uppercase text-[9px] font-bold tracking-widest px-2"
        >
          {" "}
      ...
      render: (_: any, record: Warehouse) => (
        <Tooltip title={t("common.edit")}>
          ...
          <Button
            type="text"
            icon={
              <EditOutlined className="text-gray-400 hover:text-black dark:hover:text-[#d4af37]" />
            }
    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-end">
        ...
        <div className="space-y-1">
          ...
          <Title
            level={4}
            className="!mb-0 font-serif italic text-gray-800 dark:text-gray-100"
          >
            {" "}
      ...
      >
        ...
        >
          ...
          <Form.Item
            ...
            label={
              <span className="text-[10px] uppercase tracking-widest font-bold text-gray-400">
                {t("inventory.warehouses.form.code")}
              </span>
            }
          ...
          <Form.Item
            ...
            label={
              <span className="text-[10px] uppercase tracking-widest font-bold text-gray-400">
                {t("inventory.warehouses.form.address")}
              </span>
            }
          >
            {" "}
          ...
          <Form.Item
            ...
            label={
              <span className="text-[10px] uppercase tracking-widest font-bold text-gray-400">
                {t("inventory.warehouses.form.active")}
              </span>
            }
          ...
          <div className="flex justify-end space-x-3 mt-8">
            ...
            <Button
              onClick={closeModal}
              className="h-10 border-gray-200 dark:border-gray-800 text-[10px] font-bold uppercase tracking-widest"
            >
              {" "}
              {t("common.cancel")}{" "}
            </Button>{" "}
