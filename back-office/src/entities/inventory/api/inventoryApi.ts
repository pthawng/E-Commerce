...
export const inventoryApi = {
    ...
    // Transfers
    getTransfers: () => api.get<InventoryTransfer[]>('/inventory/transfers').then(res => res.data),
    ...
    shipTransfer: (id: string) => api.post(`/inventory/transfers/${id}/ship`).then(res => res.data),

    receiveTransfer: (id: string) => api.post(`/inventory/transfers/${id}/receive`).then(res => res.data),
    ...
    // Warehouses
    getWarehouses: () => api.get<Warehouse[]>('/inventory/warehouses').then(res => res.data),
