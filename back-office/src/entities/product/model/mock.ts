...
export const MOCK_PRODUCTS: JewelryProduct[] = [
  {
    ...
    description:
      "A breathtaking 18k white gold ring featuring a central 1.5ct pear-cut diamond surrounded by a halo of brilliant-cut pavé diamonds.",
    collectionId: "c1",
    category: "rings",
    basePrice: 4500,
    ...
    media: [
      {
        ...
        alt: "Elysian Diamond Halo Ring Primary",
        isPrimary: true,
      },
    ],
    metadata: {
  ...
  },
  {
    ...
    description:
      "An exquisite platinum necklace with a cascade of Colombian emeralds and pear-shaped diamonds.",
    collectionId: "c2",
    category: "necklaces",
    basePrice: 12000,
    ...
    media: [
      {
        id: "m2",
        type: "image",
        url: "https://images.unsplash.com/photo-1599643477877-51de4ef2879f?auto=format&fit=crop&q=80&w=800",
        alt: "Seraphina Emerald Necklace",
        isPrimary: true,
      },
    ],
    metadata: {
