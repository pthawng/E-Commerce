                    ...
                    <Container className="flex items-center justify-between h-16 sm:h-20 gap-4">
                        ...
                        <div className="flex items-center gap-4">
                            <span className="font-body text-[10px] uppercase tracking-widest text-muted-foreground hidden sm:block">
                                {lastPageMeta?.totalItems || 0} Items
                            </span>
                        </div>
                    </Container>
                </div>
                    ...
                    <Container>
                        {isError ? (
                            <div className="py-20 flex justify-center text-center">
                                <Alert className="max-w-md border-destructive/20 bg-destructive/5">
                                    <AlertTitle className="text-destructive font-display tracking-wide">Error Loading Catalog</AlertTitle>
                            ...
                            <div className="py-32 text-center">
                                ...
                                <p className="font-body text-[10px] uppercase tracking-ultra text-muted-foreground/60">No items match your criteria.</p>
                            </div>
                        ) : (
                        ...
                        {hasNextPage && (
                            <div className="mt-24 text-center">
                                ...
                                >
                                    {isFetchingNextPage ? <RefreshCw className="mr-2 h-4 w-4 animate-spin" /> : "Reveal More"}
                                </Button>
                            </div>
                        )}
                    </Container>
