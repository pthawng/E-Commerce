...
import { PRODUCT_MEDIA_FALLBACK_URL } from "@shared";

export const CollectionsPage = () => {
  const { language, currency, exchangeRatesUpdatedAt, formatPrice } =
    useStore();
              ...
              <div className="relative w-full max-w-xs group">
                ...
                {searchTerm && (
                  <button
                    ...
                    className="absolute right-3 top-1/2 -translate-y-1/2 hover:text-gold"
                  >
                    <X className="w-3 h-3" />
                  </button>
                )}
            ...
            {isGridError ? (
              <div className="py-20 flex justify-center text-center">
                <Alert className="max-w-md border-destructive/20 bg-destructive/5">
                  <AlertTitle className="text-destructive font-display tracking-wide">
                    {t("common.error")}
                  </AlertTitle>
